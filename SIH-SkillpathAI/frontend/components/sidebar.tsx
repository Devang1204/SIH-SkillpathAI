...
const nav = [
  ...
  { label: "Assessments", icon: ClipboardCheck, href: "/assessment" },
  ...
  return (
    <aside className="flex h-full w-64 shrink-0 flex-col border-r border-sidebar-border bg-sidebar">
      <div className="flex items-center gap-2 px-6 py-6">
        ...
        <span className="text-lg font-bold tracking-tight text-primary">SkillGap AI</span>
      </div>
      ...
      <div className="m-4 rounded-2xl bg-sidebar-accent/70 p-4">
        ...
        <Button className="mt-4 w-full rounded-xl">Ask Now</Button>
      </div>
    </aside>
  )
}
